...
<html>
    <head>
        ...
        <title> Data Medic | Empresa</title>
    ...
    <body class="hold-transition skin-purple-light sidebar-mini">
                          ...
                          <!-- form start -->
                            ...
                            <div class="card-body">
                              <div class="form-group">
                                <button type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><ion-icon name="calendar-outline"></ion-icon> Agregar Empresa</button>
                              </div>
                              <div class="form-group">
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header bg-info">
                        <h4 class="modal-title" id = "titulomodalEmpresa">Registrar Empresa</h4>
                          ...
                          <div class="row">
                            ...
                            <div class="col-6">
                                <p>
                                    ...
                                    Razón Comercial<input type="text" 
                                                  name="txtRazonComercial" 
                                                  id="txtRazonComercial" 
                                                  class="form-control input-sm">
                                </p>
                            </div>
                          </div>
        ...
        <script src="js/gestionarEmpresa.js" type="text/javascript"></script>
