...
<html>
    ...
    <body class="hold-transition skin-purple-light sidebar-mini">
                    ...
                    <div class="row mb-2">
                      ...
                      <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          ...
                          <li class="breadcrumb-item active">Módulo Doctor</li>
                        </ol>
                      </div>
                    </div>
                  </div><!-- /.container-fluid -->
                          ...
                          <!-- form start -->
                            ...
                            <div class="card-body">
                              <div class="form-group">
                                <button type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><ion-icon name="calendar-outline"></ion-icon> Agregar Doctor</button>
                              </div>
                              <div class="form-group">
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header bg-info">
                        <h4 class="modal-title" id = "titulomodalDoctor">Registrar Doctor</h4>
                          ...
                          <div class="row">
                            ...
                            <div class="col-6">
                                <p>
                                    ...
                                    Codigo_colegio<input type="text" 
                                                  name="txtCodigo_colegio" 
                                                  id="txtCodigo_colegio" 
                                                  class="form-control input-sm">
                                </p>
                            </div>
                          </div>
        ...
        <script src="js/gestionarDoctor.js" type="text/javascript"></script>
