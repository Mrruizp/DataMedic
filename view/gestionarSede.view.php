...
<html>
    <head>
        ...
        <title> Sistema Dental | Sede</title>
    ...
    <body class="hold-transition skin-purple-light sidebar-mini">
                    ...
                    <div class="row mb-2">
                      ...
                      <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          ...
                          <li class="breadcrumb-item active">Módulo de Sede</li>
                        </ol>
                      </div>
                    </div>
                  </div><!-- /.container-fluid -->
                          ...
                          <!-- form start -->
                            ...
                            <div class="card-body">
                              <div class="form-group">
                                ...
                                <button type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><ion-icon name="calendar-outline"></ion-icon> Agregar Sede</button>
        ...
        <script src="js/gestionarSede.js" type="text/javascript"></script>
