...
<html>
    <head>
        ...
        <title> Sistema Dental | Consultorio</title>
    ...
    <body class="hold-transition skin-purple-light sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                  <div class="container-fluid">
                    <div class="row mb-2">
                      <div class="col-sm-6">
                        <h1>Módulo Consultorio</h1>
                      </div>
                      <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="menu.principal.view.php">Inicio</a></li>
                          <li class="breadcrumb-item active">Módulo de Consultorio</li>
                        </ol>
                      </div>
                    </div>
                  </div><!-- /.container-fluid -->
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="card card-default">
                          <div class="card-header">
                            <h3 class="card-title">Consultorio</h3>
                          </div>
                          <!-- /.card-header -->
                          <!-- form start -->
                            ...
                            <div class="card-body">
                              <div class="form-group">
                                ...
                                <button type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><ion-icon name="calendar-outline"></ion-icon> Agregar Consultorio</button>
        ...
        <script src="js/gestionarConsultorio.js" type="text/javascript"></script>
