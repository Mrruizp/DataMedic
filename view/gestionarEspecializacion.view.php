...
<html>
    ...
    <body class="hold-transition skin-purple-light sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                  <div class="container-fluid">
                    <div class="row mb-2">
                      <div class="col-sm-6">
                        <h1>Módulo Especialización</h1>
                      </div>
                      <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="menu.principal.view.php">Inicio</a></li>
                          <li class="breadcrumb-item active">Módulo de Especialización</li>
                        </ol>
                      </div>
                    </div>
                  </div><!-- /.container-fluid -->
                          ...
                          <!-- form start -->
                            ...
                            <div class="card-body">
                              <div class="form-group">
                                <button type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><ion-icon name="calendar-outline"></ion-icon> Agregar Especialización</button>
                              </div>
                              <div class="form-group">
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header bg-info">
                        <h4 class="modal-title" id = "titulomodalEspecializacion">Registrar Especialización</h4>
                          ...
                          <div class="row">
                            <div class="col-6">
                                <p>
                                    ...
                                    Especialidad <select class="form-control" name="txtEspecialidad" id="txtEspecialidad">
                                          </select>
                                </p>
                            </div>
                            <div class="col-6">
                                <p>
                                    ...
                                    Doctor <select class="form-control" name="txtDoctor" id="txtDoctor">
                                          </select>
                                </p>
                            </div>
                          </div>
        ...
        <script src="js/gestionarEspecializacion.js" type="text/javascript"></script>
