...
<html>
    ...
    <body class="hold-transition skin-purple-light sidebar-mini">
                    ...
                    <div class="row mb-2">
                      ...
                      <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          ...
                          <li class="breadcrumb-item active">Módulo de Área</li>
                        </ol>
                      </div>
                    </div>
                  </div><!-- /.container-fluid -->
                          ...
                          <!-- form start -->
                            ...
                            <div class="card-body">
                              <div class="form-group">
                                <button type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><ion-icon name="calendar-outline"></ion-icon> Agregar Área</button>
                              </div>
                              <div class="form-group">
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header bg-info">
                        <h4 class="modal-title" id = "titulomodalArea">Registrar Área</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <p>
                                    ...
                                    Nombre de la Área<input type="text" 
                                                  name="txtArea" 
                                                  id="txtArea" 
                                                  class="form-control input-sm">
                                </p>
        ...
        <script src="js/gestionarArea.js" type="text/javascript"></script>
